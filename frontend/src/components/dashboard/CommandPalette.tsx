...
const searchRoutes: SearchRoute[] = [
  ...
  { label: 'Q-Score Overview', path: '/dashboard/rating/enterprise', icon: Star, group: 'Q-Score Overview', keywords: ['q-score', 'score', 'enterprise'] },
  { label: 'Per-Asset Q-Score', path: '/dashboard/rating/per-asset', icon: FileText, group: 'Q-Score Overview', keywords: ['q-score', 'asset'] },
  { label: 'View PQC Tier Criteria', path: '/dashboard/rating/enterprise?tiers=open', icon: HelpCircle, group: 'Q-Score Overview', keywords: ['tier', 'classification', 'criteria'] },
  { label: 'Action Plan', path: '/dashboard/remediation/action-plan', icon: Wrench, group: 'Remediation', keywords: ['remediation', 'action', 'fix'] },
  { label: 'Patch Generator', path: '/dashboard/remediation/patch', icon: Sparkles, group: 'Remediation', keywords: ['patch', 'config', 'fix', 'remediation'] },
