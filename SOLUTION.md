...
graph TB
    ...
    subgraph L4["LAYER 4 — THREAT INTELLIGENCE RAG"]
        LangChain[LangChain Workflow<br>Orchestration]
...
flowchart LR
    ...
    VULN_CBOM --> LangChain[LangChain Workflow<br>Orchestration Engine]
...
graph LR
    ...
    subgraph INTEL["Intelligence Stack"]
        LangChain_T[LangChain<br>RAG workflow<br>orchestration]
